...
const Footer = () => (
  <footer className="footer">
    <div className="org-icon footer-content">
        <img id="org-icon" alt='logo' src="http://homeless.lacounty.gov/wp-content/uploads/2017/01/homeless_initiative_logo.png" />
    </div>
    <div className="quick-links-footer footer-content">
        <div className="quick-links-content">
                ...
                <p className="link"><a href="/organizations">Organizations</a></p>
        </div>
    </div>
    <div className="social-media-footer footer-content">
        ...
        <div className="social-media-btn-container">
            <div className="social-media-btn">
                <img id="social-media-btn" alt="twitter logo" src="http://www.stickpng.com/assets/images/580b57fcd9996e24bc43c53e.png"/>
            </div>
            <div className="social-media-btn">
                <img id="social-media-btn" alt="instagram logo" src="http://www.transparentpng.com/download/logo-instagram/Sj4fEy-instagram-png-logo-high-quality.png"/>
            </div>
        </div>
    </div>
