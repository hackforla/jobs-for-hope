...
def run(url):
    ...
    for job_row in job_listings:
        globals.job_title = job_row.find('td',{'class':'posTitle'}).text.strip()
        globals.info_link = 'http://mhala.hrmdirect.com/employment/' + job_row.find('td',{'class':'posTitle'}).a['href']
